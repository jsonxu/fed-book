# node.js 技术栈
精心挑选的一些nodejs、express、koa2相关的最常用的框架、组件、类库、中间件、项目源码 等等 .
keyword: nodejs, mongodb, express, middleware.

## 框架
- [express]() express nodejs框架，非常流行的开发框架

## node 工具

- [nodemon](https://github.com/remy/nodemon) - 监听node文件的变化，文件编辑变化后自动重启服务器，使新的代码生效，作用于node全局
- [pm2](https://github.com/Unitech/pm2) - 生产运行时和进程管理器的Node.js应用程序，内置的负载平衡

## node 中间件
- [serve-favicon](https://github.com/expressjs/serve-favicon) - 为网站设置favicon图标
- [ejs]() - ejs模板引擎
- [cookie-parser]() - cookie管理中间件
- [debug]() - nodejs开发debug专用
- [express-session]() - session管理
- [connect-mongo]() - mango数据库链接管理
- [body-parser](https://www.npmjs.com/package/body-parser) - 一般是用来解析POST请求数据的中间件，最常用
- [body](https://www.npmjs.com/package/body) - 一般是用来解析POST请求数据
- [co-body](https://www.npmjs.com/package/co-body) - 一般是用来解析POST请求数据
- [raw-body](https://www.npmjs.com/package/raw-body) - 一般是用来解析POST请求数据
- [socket.io](https://github.com/socketio/socket.io) - 处理socket通讯
...
- [serve-favicon](https://www.npmjs.com/package/serve-favicon) - favicon图标管理
- [serve-index](https://www.npmjs.com/package/serve-index) - previously `directory`
- [serve-static](https://www.npmjs.com/package/serve-static) - 静态文件服务
